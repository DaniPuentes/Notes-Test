...
```
```{r}
### Let's create a data set and see the distribution of the residuals 
plot(model$residuals)
#make predictions
my_model_preds = predict(model, data=mtcars,  se.fit = TRUE, type = 'response')

#ggplot of the model
ggplot(data=mtcars, aes(x=wt, y=am, color=as.factor(am))) + geom_point() +
  geom_line(aes(x = wt, y= my_model_preds$fit), col = 'blue') + theme
```
